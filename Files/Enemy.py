...
class Enemy(object):
  ...
  def update(self, dt, player, cQueue):
    ...
    for i in range(cQueue.getNumEntries()):
        if cQueue.getEntry(i).getIntoNode().getName() == 'vision' and self.foundPlayer == False and self.sightBlocked == False:
